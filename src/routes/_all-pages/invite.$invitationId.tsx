...
// import { OTPSignIn } from '@/features/auth/components/otp-sign-in' // Component not found
...
export const Route = createFileRoute('/_all-pages/invite/$invitationId')({
  loader: async ({ params }) => {
    try {
        ...
        <div className="bg-card rounded-xl shadow-lg p-8 w-full max-w-md">
          <div className="text-center">
            <p className="text-sm text-muted-foreground mb-4">
              OTP Sign-in component is temporarily unavailable.
            </p>
            <p className="text-xs text-muted-foreground">
              Please contact support to access this invitation.
            </p>
          </div>
          {/* <OTPSignIn
            email={invitation.email}
