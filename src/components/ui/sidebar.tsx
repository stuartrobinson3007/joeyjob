...
function Sidebar({
  ...
  const { shouldShowSuperAdminFrame, superAdminBarHeight } = useSuperAdminWrapper()
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          ...(shouldShowSuperAdminFrame && {
            top: `${superAdminBarHeight}px`,
            height: `calc(100vh - ${superAdminBarHeight}px)`,
            paddingLeft: '5px',
            paddingBottom: '5px',
          }),
        }}
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  ...
  return (
    <main
      ...
      style={{
        ...(shouldShowSuperAdminFrame && {
          paddingTop: `${superAdminBarHeight}px`,
          paddingRight: '5px',
        }),
      }}
      {...props}
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button text-sidebar-foreground flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:size-8 group-data-[collapsible=icon]:p-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
